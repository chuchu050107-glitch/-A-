...
function renderHome() {
  ...
  main.innerHTML = `
    ...
    <p class="lede">โครงสร้างข้อมูลและอัลกอริทึม — เนื้อหาเรียบเรียงจากเอกสารบรรยาย 7 บท
...
function examHeader(active) {
  ...
  return `
    ...
    และอัตนัย ${written.length} ข้อ โค้ดในโจทย์และเฉลยทั้งหมดอิงตามเอกสารบรรยาย</p>
    <div class="tabs">
